<template>
      ...
      <div class="container"  data-aos="fade-up">
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="item">
              <div class="item">
                <img src="assets/images/slider-1.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <!-- <div class="item">
                <img src="assets/images/slider-2.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
              </div>
              <div class="item">
                <img src="assets/images/slider-3.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
              </div> -->
            </div> <!-- .owl-carousel -->
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-6 col-sm-6 col-md-6 col-lg-4">
          <div class="staff staff-img" style="background-image: url(assets/images/person_1.jpg);">
            <a href="#" class="desc">
              <h3>Bob Miller</h3>
        ...
        <div class="col-6 col-sm-6 col-md-6 col-lg-4">
          <div class="staff staff-img" style="background-image: url(assets/images/person_2.jpg);">
            <a href="#" class="desc">
              <h3>Jean Smith</h3>
              <span>CEO and Co-Founder</span>
              <div class="parag">
        ...
        <div class="col-6 col-sm-6 col-md-6 col-lg-4">
          <div class="staff staff-img" style="background-image: url(assets/images/person_3.jpg);">
            <a href="#" class="desc">
              <h3>David Wilson</h3>
              <span>CEO and Co-Founder</span>
              <div class="parag">
  ...
  <div class="container templateux-section">
    ...
    <div class="d-flex flex-sm-row">
      <a href="#" class="block-thumbnail-1 one-third" style="background-image: url('/assets/images/slider-2.jpg'); " data-aos="fade">
        <div class="block-thumbnail-content">
          <h2>When she reached the first</h2>
          <span class="post-meta">June 18, 2020  &bullet; by Admin</span>
        </div>
      </a>
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url('/assets/images/slider-1.jpg'); " data-aos="fade" data-aos-delay="100">
        <div class="block-thumbnail-content">
    ...
    <div class="d-flex flex-column flex-sm-row">
      <a href="#" class="block-thumbnail-1 two-third" style="background-image: url('/assets/images/slider-3.jpg'); " data-aos="fade" data-aos-delay="200">
        <div class="block-thumbnail-content">
          <h2>Italic Mountains</h2>
          <span class="post-meta">March 18, 2020  &bullet; by Admin</span>
        </div>
      </a>
      <a href="#" class="block-thumbnail-1 one-third" style="background-image: url('/assets/images/slider-4.jpg'); " data-aos="fade" data-aos-delay="300">
        <div class="block-thumbnail-content">
